...
SCHOOLS_2026 = [
    ...
    School("杭高贡院",      "重高", "A", 672,  0.70, 12,   73, "百年名校，文科见长"),
    School("十四凤起",      "重高", "A", 624,  0.70, 11,   159, "理科强校，竞赛突出"),
    School("学军紫金港",    "重高", "A", 720,  0.40, 7,    111, "学军新校区，上升快"),
    School("杭四下沙",      "重高", "A", 624,  0.70, 11,   210, "国际化特色"),
    School("浙大附玉泉",    "重高", "B", 624,  0.70, 11,   230, "浙大资源支持"),
    School("长河高中",      "重高", "B", 624,  0.70, 11,   295, "滨江区旗舰，可捡漏"),
    School("杭高钱江",      "重高", "B", 672,  0.40, 7,    306, "杭高分校，可捡漏3分"),
    School("杭师附中",      "重高", "B", 720,  0.70, 13,   250, "师范类底子"),
    School("杭二高新",      "重高", "B", 864,  0.40, 9,    None, "2026新增！杭二分校"),
    School("浙大附实验",    "重高", "B", 672,  0.40, 7,    None, "2026新增！浙大附分校"),
    School("学军海创园",    "重高", "C", 576,  0.40, 6,    350, "学军集团"),
    School("杭二钱江",      "重高", "C", 384,  0.40, 4,    380, "杭二集团"),
    School("杭高钱塘",      "重高", "C", 1008,  0.40, 10,   370, "杭高集团"),
    School("杭高临平",      "重高", "C", 384,  0.40, 4,    420, "杭高集团新校"),
    School("十四康桥",      "重高", "C", 768,  0.40, 8,    400, "十四中分校"),
    School("浙大附丁兰",    "重高", "C", 672,  0.40, 7,    430, "浙大附分校"),
    School("杭四江东",      "重高", "C", 672,  0.40, 7,    450, "杭四集团"),
    School("杭二东河",      "重高", "C", 480,  0.40, 5,    500, "杭二集团"),
    School("杭二富春",      "重高", "C", 384,  0.40, 4,    480, "杭二集团"),
    School("学军桐庐",      "重高", "C", 384,  0.40, 4,    500, "学军集团"),
    School("十四青山湖",    "重高", "C", 384,  0.40, 4,    520, "十四中分校"),
    School("长河二高",      "重高", "C", 960,  0.40, 10,   550, "长河分校"),

    # ── 优高 ──
    School("源清中学",      "优高", "C", 768,  0.40, 8,    600, "拱墅区优高"),
    School("杭七转塘",      "优高", "C", 528,  0.40, 5,    650, "美术特色"),
    School("杭师大附二中",  "优高", "C", 768,  0.40, 8,    680, "杭师附分校"),
    School("源清二高",      "优高", "C", 672,  0.40, 7,    700, "源清分校"),
    School("杭四吴山",      "优高", "D", 432,  0.40, 4,    750, "杭四分校"),
    School("绿城育华",      "优高", "D", 240,  0.40, 2,    800, "民办 26000/学期"),
]
